          ...
          <div className="card">
            <div className="card-header">
              <div className="row">
                ...
                <div className="col-md-6">
                  <Link to="/patients/add" className="btn btn-md bg-primary float-right">เพิ่มผู้ป่วย</Link>
                </div>
              </div>
            </div>
                    ...
                    return (
                      <tr key={patient.hn}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <Link className="btn btn-sm bg-info">
                            <i class="fas fa-search"></i>
                          </Link>
                          <Link className="btn btn-sm bg-warning">
                            <i class="fas fa-edit"></i>
                          </Link>
                          <Link className="btn btn-sm bg-danger">
